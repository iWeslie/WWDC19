...
public class DeployPortalViewController: UIViewController, ARSCNViewDelegate {
    ...
    func setupHUD() {
        ...
        playBtn = UIButton(frame: CGRect(x: UIScreen.main.bounds.width / 2 - 100, y: 200, width: 200, height: 80))
